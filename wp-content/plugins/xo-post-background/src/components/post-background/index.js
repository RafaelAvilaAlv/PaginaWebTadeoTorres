		...
		>
			<div className="editor-post-featured-image">
				...
				{meta._xo_background.id > 0 && (
					<MediaUploadCheck>
						<MediaUpload
							title={__('Replace Image', 'xo-post-background')}
							value={meta._xo_background.id}
							onSelect={onUpdateImage}
							allowedTypes={['image']}
							render={({ open }) => (
								<Button onClick={open} variant="secondary">
									{__('Replace Image', 'xo-post-background')}
								</Button>
							)}
						/>
					</MediaUploadCheck>
				...
				{meta._xo_background.id > 0 && (
					<MediaUploadCheck>
						<Button
							...
							isDestructive
						>
							{__('Remove background image', 'xo-post-background')}
						</Button>
					</MediaUploadCheck>
				)}
						...
						{typeof GradientPicker === 'undefined' ? (
							...
							<>
								...
								{! meta._xo_background.gradient ? (
									...
									<GradientPicker
										gradients={[]}
										value={meta._xo_background.custom_gradient}
